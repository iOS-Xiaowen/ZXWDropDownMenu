...
@interface ViewController ()<ZXWDropDownMenuDataSource,ZXWDropDownMenuDelegate>{
...
- (void)viewDidLoad {
    ...
    ZXWDropDownMenu *menu = [[ZXWDropDownMenu alloc] initWithOrigin:CGPointMake(0, 20) andHeight:45];
